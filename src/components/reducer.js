...
const reducer = (state, action) => {
  ...
  const favoritesCategories = state.favorites
  ...
  switch (action.type) {
    ...
    case "ADD_FAVORITE":
      let arrayAfterAdd = favoritesCategories.includes(category)
        ? [...state.favorites[category], favorite]
        : [favorite];
      //Save it locally
    ...
    case "DELETE_FAVORITE":
      let arrayAfterDelete = state.favorites[category].filter(
